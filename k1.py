...
class k1Spider(scrapy.Spider):
    ...
    def parse_place1(self, response):
        ...
        places1 = response.xpath("//ul[@class='_19hUB53v']/li")
        for place1 in places1:
            sub_places = place1.xpath(".//div/a/div[2]/div/div/text()").get()

            link = place1.xpath(".//div/a/@href").get()

            yield response.follow(url=link, callback=self.parse_place2,
                                  meta={'main_places': tourist_places, 'sub_places': sub_places})
